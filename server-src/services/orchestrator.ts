  ...
  return [
    {
      ...
      content: interpolateBillboards(homepageV2, billboard(homepageV2AdPrefix)),
      fallback: interpolateBillboards(homepage, billboard(homepageAdPrefix))
    }
  ];
};
