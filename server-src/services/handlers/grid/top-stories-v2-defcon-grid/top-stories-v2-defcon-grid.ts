...
export default async function (
  ...
  const mobile: IGridConfig = {
    ...
    gridBlocks: {
      ...
      [TopStoriesV2DefconGridPositions.RightOne]: gridBlock(4, 1, 1, 2, [
        Border.bottom,
      ]),
      [TopStoriesV2DefconGridPositions.RightTwo]: gridBlock(5, 1, 1, 2, [
        Border.bottom,
      ]),
      [TopStoriesV2DefconGridPositions.LeftThree]: gridBlock(8, 1, 1, 1, [
        Border.bottom,
      ]),
      [TopStoriesV2DefconGridPositions.LeftFour]: gridBlock(8, 2, 1, 1, [
        Border.bottom,
      ]),
      [TopStoriesV2DefconGridPositions.RightThree]: gridBlock(6, 1, 1, 2, [
        Border.bottom,
      ]),
  ...
  const tablet: IGridConfig = {
    ...
    gridBlocks: {
      ...
      [TopStoriesV2DefconGridPositions.LowerRight]: gridBlock(8, 3, 3, 1, []),
    },
  };
