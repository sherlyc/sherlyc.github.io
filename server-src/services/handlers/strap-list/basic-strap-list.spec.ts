import strapListHandler from './basic-strap-list';
...
describe('strapListHandler', () => {
  ...
  it('should get a list of basic article units and ad units', async () => {
    ...
    (getStrapArticles as jest.Mock).mockResolvedValue([articleNumberOne]);

    const handlerRunnerMock = jest.fn();

    const contentBlocks = await strapListHandler(
      handlerRunnerMock,
      {
